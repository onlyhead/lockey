...
inline std::vector<uint8_t> Common::xor_bytes(const std::vector<uint8_t>& a, 
                                             const std::vector<uint8_t>& b) {
    if (a.size() != b.size()) {
...
inline std::vector<uint8_t> Common::pkcs7_pad(const std::vector<uint8_t>& data, 
                                             size_t block_size) {
    if (block_size > 255) {
