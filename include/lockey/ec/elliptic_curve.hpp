...
struct Point {
    ...
    Point() = default;
    Point(const std::vector<uint8_t>& x_coord, const std::vector<uint8_t>& y_coord) 
        : x(x_coord), y(y_coord) {}
...
struct Signature {
    ...
    Signature() = default;
    Signature(const std::vector<uint8_t>& r_val, const std::vector<uint8_t>& s_val)
        : r(r_val), s(s_val) {}
};
...
struct KeyPair {
    ...
    KeyPair() = default;
    KeyPair(const std::vector<uint8_t>& priv, const Point& pub)
...
public:
    ...
    // ECDSA operations
    virtual Signature sign(const std::vector<uint8_t>& hash, 
                          const std::vector<uint8_t>& private_key) const = 0;
...
public:
    ...
    std::vector<uint8_t> mod_add(const std::vector<uint8_t>& a, 
                                const std::vector<uint8_t>& b,
                                const std::vector<uint8_t>& mod) const;
    std::vector<uint8_t> mod_sub(const std::vector<uint8_t>& a,
                                const std::vector<uint8_t>& b,
                                const std::vector<uint8_t>& mod) const;
    std::vector<uint8_t> mod_mul(const std::vector<uint8_t>& a,
                                const std::vector<uint8_t>& b,
                                const std::vector<uint8_t>& mod) const;
    std::vector<uint8_t> mod_inv(const std::vector<uint8_t>& a,
                                const std::vector<uint8_t>& mod) const;
    std::vector<uint8_t> mod_exp(const std::vector<uint8_t>& base,
...
public:
    ...
    Signature sign(const std::vector<uint8_t>& hash, 
                  const std::vector<uint8_t>& private_key) const override;
